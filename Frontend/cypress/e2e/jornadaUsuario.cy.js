describe('Jornadas de usuário', () => {
  ...
  cy.getByData('lista-transacoes').find('h3').last().contains('- R$ 80') /* no histórico de transações (ul), encontraremos um li, o último, que contenha o valor que inserimos */
  ...
  it('Deve permitir que o usuário acesse a aplicação, realize um depósito e faça logout', () => {
    ...
    cy.getByData('lista-transacoes').find('h3').last().contains('R$ 80') 
